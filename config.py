...
There may be three document provided. One will be of the type "External Evaluation", one will be "Project Report", and the third one may be "Original Proposal". The project report was prepared by the organization running the project and will have information and details according to their perspective. The external evaluation is an evaluation of the final project report by an external evaluator and will have information and details according to that perspective. To answer the questions in this assessment process, you should give the greatest weight to the external evaluation and use the project report to provide additional details that may be relevant but which were not present in the external evaluation. The Original Proposal document is only relevant to questions that compare planned activities, outputs or results with actual activitiies, outputs or results.

Important!: When generating responses about project outputs and results OMLY CONSIDER the External Evaluation and Project Report documents. Only consider the additional Original Proposal document for responses that compare proposed activities, outputs or results with actual activities, outputs or results.
