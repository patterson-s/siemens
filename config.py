...
class Config:
    ...
    # App configuration
    APP_NAME = "SII AI Assessment Tool"
...
Important!: Format your response using markdown with clear sections and follow the exact format of the analysis steps, including all levels of bullet points. If there is no relevant data for a bullet point, say no relavant data.

There may be three documents provided.  One will be of the type "external_evaluation" another will be "final_project_report" and a third may be "original_proposal". The final project report was prepared by the organization running the project and will have information and details according to their perspective. The external evaluation is an evaluation of the final project report by an external evaluator and will have information and details according to that perspective. To answer the questions in this assessment process, you should give the greatest weight to the external evaluation and use the final project report to provide addiitional details that may be relevant but which were not present in the external evaluation. The original_proposal is the original proposal for the project and will have information and details according to the perspective of the organization that prepared the proposal. The original_proposal should only be considered for questions 2.1 b Intended Outputs Achieved and 2.6 Internal Factors.
